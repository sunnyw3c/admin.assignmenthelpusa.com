...
<div x-data="{ items: {{ json_encode($items) }} }">
    <div class="flex items-center justify-between mb-3">
        <label class="text-xs font-medium text-zinc-500">Steps</label>
                ...
                <div class="flex items-center gap-3">
                    <div class="flex-1 grid grid-cols-6 gap-3">
                        <input type="text" x-model="item.step" placeholder="01"
                               class="border border-zinc-200 dark:border-zinc-800 rounded-lg px-3 py-2 text-sm bg-white dark:bg-zinc-900 focus:outline-none focus:ring-2 focus:ring-accent/40 transition text-center font-mono">
                        <input type="text" x-model="item.icon" placeholder="Icon"
                               class="border border-zinc-200 dark:border-zinc-800 rounded-lg px-3 py-2 text-sm bg-white dark:bg-zinc-900 focus:outline-none focus:ring-2 focus:ring-accent/40 transition text-center">
                        <input type="text" x-model="item.title" placeholder="Step Title" class="col-span-3 border border-zinc-200 dark:border-zinc-800 rounded-lg px-3 py-2 text-sm bg-white dark:bg-zinc-900 focus:outline-none focus:ring-2 focus:ring-accent/40 transition">
